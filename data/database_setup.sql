...
CREATE TABLE TVShows (TVShows_ID INT(3) AUTO_INCREMENT NOT NULL PRIMARY KEY, TVShows_Name VARCHAR(50) UNIQUE NOT NULL, TVShows_Finished BOOLEAN DEFAULT 0, Users_ID INT(3), Streaming_Platforms_ID INT(3), FOREIGN KEY(Users_ID) REFERENCES Users (Users_ID) ON DELETE CASCADE, FOREIGN KEY(Streaming_Platforms_ID) REFERENCES Streaming_Platforms (Streaming_Platforms_ID) ON DELETE CASCADE);
CREATE TABLE Games (Games_ID INT(3) AUTO_INCREMENT NOT NULL PRIMARY KEY, Games_Name VARCHAR(50) UNIQUE NOT NULL, Games_Finished BOOLEAN DEFAULT 0, Users_ID INT(3), Consoles_ID INT(3), FOREIGN KEY(Users_ID) REFERENCES Users (Users_ID) ON DELETE CASCADE, FOREIGN KEY(Consoles_ID) REFERENCES Consoles (Consoles_ID) ON DELETE CASCADE);
CREATE TABLE Books (Books_ID INT(3) AUTO_INCREMENT NOT NULL PRIMARY KEY, Books_Name VARCHAR(50) UNIQUE NOT NULL, Books_Finished BOOLEAN DEFAULT 0, Users_ID INT(3), FOREIGN KEY(Users_ID) REFERENCES Users (Users_ID) ON DELETE CASCADE);
CREATE TABLE Films (Films_ID INT(3) AUTO_INCREMENT NOT NULL PRIMARY KEY, Films_Name VARCHAR(50) UNIQUE NOT NULL, Films_Finished BOOLEAN DEFAULT 0, Users_ID INT(3), Streaming_Platforms_ID INT(3), FOREIGN KEY(Users_ID) REFERENCES Users (Users_ID) ON DELETE CASCADE, FOREIGN KEY(Streaming_Platforms_ID) REFERENCES Streaming_Platforms (Streaming_Platforms_ID) ON DELETE CASCADE);
